...
var TableLayout = function () {
  ...
  TableLayout.prototype.setHeight = function setHeight(value) {
    ...
    if (!el && (value || value === 0)) {
      // strict multi call setHeight
      this.isSettingHeight = true;
      return _vue2.default.nextTick(function () {
        _this.isSettingHeight && _this.setHeight(value, prop);
      });
    };
...
exports.default = {
        ...
        [this._l(columnRows, function (columns, rowIndex) {
          return h(
            ...
            [_this._l(columns, function (column, cellIndex) {
                ...
                [h(
                  ...
                  [column.renderHeader ? column.renderHeader.call(_this._renderProxy, h, { column: column, $index: cellIndex, store: _this.store, _self: _this.$parent.$vnode.context }) : column.label, column.sortable ? h(
                    ...
                    [h(
                      ...
                      []
                    ), _this.isUseSortColumn(column) && h(
                      'span',
                      { 'class': 'sort-caret-order' },
                      [_this.getMultiSortOrder(column)]
                    )]
                  ) : '', column.filterable ? h(
                    'span',
              ...
              'th',
              { 'class': 'gutter', style: { width: _this.tableLayout.scrollY ? _this.tableLayout.gutterWidth + 'px' : '0' } },
              []
            ) : '']
          );
        }), this.isRowAddition() && h(
          'tr',
          null,
          [this._l(this.columns, function (column, cellIndex) {
            return h(
              'th',
              null,
              [_this.table.headerRowAddition(h, { column: column, $index: cellIndex })]
            );
          }), this.hasGutter ? h(
            'th',
            { 'class': 'gutter', style: { width: this.tableLayout.scrollY ? this.tableLayout.gutterWidth + 'px' : '0' } },
            []
          ) : '']
        )]
      )]
  ...
  methods: {
    ...
    isRowAddition: function isRowAddition() {
      var headerRowAddition = this.table.headerRowAddition;
    ...
    getHeaderCellClass: function getHeaderCellClass(rowIndex, columnIndex, row, column) {
      ...
      if (this.table.isMultiSort) {
        ...
        var sortColumn = states.sortMap.get(property);
    ...
    getKeysSortMap: function getKeysSortMap() {
      var states = this.store.states;

      var keysSortMap = Array.from(states.sortMap.keys());
      var keysSortArray = [];

      keysSortMap.forEach(function (key) {
        return keysSortArray.push(key);
      });

      return keysSortArray;
    },
    isUseSortColumn: function isUseSortColumn(column) {
      var property = column.property;

      var keysSortMap = this.getKeysSortMap();

      return this.table.isMultiSort && keysSortMap.includes(property);
    },
    getMultiSortOrder: function getMultiSortOrder(column) {
      var property = column.property;


      var keysSortMap = this.getKeysSortMap();
      var order = keysSortMap.indexOf(property);
    ...
    handleSortClick: function handleSortClick(event, column, givenOrder) {
      ...
      if (this.table.isMultiSort) {
        var prop = column.property;
        var sortColumn = states.sortMap.get(prop);
        var _order = givenOrder || this.toggleOrder(sortColumn && sortColumn.order);

        if (sortColumn) {
          if (_order) {
            _order !== sortColumn.order && states.sortMap.set(prop, { prop: prop, order: _order });
          } else {
            states.sortMap.delete(prop);
          };
        } else {
          _order && states.sortMap.set(prop, { prop: prop, order: _order });
        };
      };
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"el-table",class:[{
    ...
    _vm.fixedHeight])},[(_vm.showHeader)?_c('div',{ref:"fixedHeaderWrapper",staticClass:"el-table__fixed-header-wrapper"},[_c('table-header',{ref:"fixedTableHeader",style:({
      ...
      _vm.fixedBodyHeight])},[_c('div',{staticClass:"el-table__fixed-body-wrapper__scroller"},[_c('table-body',{style:({
            width: _vm.layout.fixedWidth ? _vm.layout.fixedWidth + 'px' : ''
...
var forced = {
  ...
  index: {
    renderHeader: function renderHeader(h, _ref3) {
      ...
      return column.renderIndexHeader && column.renderIndexHeader(h, { column: column }) || column.label || '#';
    },
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('span',[_c('transition',{attrs:{"name":_vm.transition},on:{"after-leave":_vm.destroyed}},[_c('div',{directives:[{name:"show",rawName:"v-show",value:(!_vm.disabled && _vm.showPopper),expression:"!disabled && showPopper"}],ref:"popper",staticClass:"el-popover el-popper",class:[_vm.popperClass, _vm.content && 'el-popover--plain'],style:({ width: _vm.width + 'px' }),attrs:{"role":"tooltip","id":_vm.tooltipId,"aria-hidden":(_vm.disabled || !_vm.showPopper) ? 'true' : 'false'}},[(_vm.title)?_c('div',{staticClass:"el-popover__title",domProps:{"textContent":_vm._s(_vm.title)}}):_vm._e(),_vm._t("default",[_vm._v(_vm._s(_vm.content))])],2)]),_vm._t("reference")],2)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
exports.default = {
  ...
  created: function created() {
    ...
    this.checkShowCheckbox = tree.checkShowCheckbox;
